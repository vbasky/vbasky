...
- 🔭 I’m currently building **[revelo](https://github.com/vbasky/revelo)** — a safe, fast Rust port of MediaInfoLib that reads technical and tag metadata from 177+ audio, video, image, and container formats. Drop-in libmediainfo replacement with CLI, C ABI, and Homebrew support.
- 🌱 Exploring the Azure AI stack, Rust systems programming, and distributed video infrastructure
